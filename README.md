...
### 1. 重置视图（Reset View）
- 一键将三维地球视角恢复到初始默认状态，方便用户快速定位和回归核心场景。
- 适用于频繁缩放/拖拽/旋转地球后，需重回指定视点的场景。
  
### 预览
<img src="./images/ResetView.png" width="60%" alt="重置视图演示" />

### 2. 显示 EVI（植被指数）功能
- 集成拥有自定义按钮的“显示EVI”功能，支持在地球表面渲染EVI（Enhanced Vegetation Index）数据图层。
- 用户可视化查看全球或区域植被生态情况，适用于地理分析、遥感学习、环保演示等多场景。
- 该功能由本人独立完善，提升了项目的应用深度和教学演示能力。
  
### 预览
<img src="./images/showEVI.png" width="60%" alt="显示EVI演示" />
---

> 本仓库为【二次开发/基于xx项目深度改进】
> 在原有功能基础上，新增了“重置视图”和“显示EVI”两项关键自研能力，更适合实际业务和科研使用。
